...
Follow ig @callang172`
			...
			case "jadibot":
				reply(
					"Cara Jadi Bot Dengan Cara Pengajaran membuat Open Pengajaran murid,jual script bot,pengajaran buat bot harga Terjangkau Kak Cmn 30k perma Minat? chat wa Creator ya wa.me/6285340783774 (Creator Bot)")
				break
			case "ingfocreator":
				reply(
					"BOT DI BUAT OLEH : CALLANG Base Dari Mhnak BarBAr,aruga,nurutomo")
				break
			case "belidlgrowtopia":
				reply(
					"Botchi Menyediakan Diamond Lock Growtopia Harga? 9k / 9000/diamond lock...Minat? Chat wa.me/6285340783774 (AMAN TERPERCAYA)")
				break
			case 'gelud':
				if (isGame(
						sender,
